...
const convertToFraction = (value) => {
  ...
  if (Number.isInteger(numValue)) {
    ...
    if (Math.abs(fracPart - 0.125) < 0.0001) { // 1/8
      return intPart > 0 ? `${intPart} 1/8` : "1/8";
    } else if (Math.abs(fracPart - 0.25) < 0.0001) { // 1/4
      return intPart > 0 ? `${intPart} 1/4` : "1/4";
    } else if (Math.abs(fracPart - 0.375) < 0.0001) { // 3/8
      return intPart > 0 ? `${intPart} 3/8` : "3/8";
    } else if (Math.abs(fracPart - 0.5) < 0.0001) { // 1/2
      return intPart > 0 ? `${intPart} 1/2` : "1/2";
    } else if (Math.abs(fracPart - 0.625) < 0.0001) { // 5/8
      return intPart > 0 ? `${intPart} 5/8` : "5/8";
    } else if (Math.abs(fracPart - 0.75) < 0.0001) { // 3/4
      return intPart > 0 ? `${intPart} 3/4` : "3/4";
    } else if (Math.abs(fracPart - 0.875) < 0.0001) { // 7/8
