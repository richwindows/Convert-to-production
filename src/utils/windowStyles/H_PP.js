...
const processH_PP = (windowData, calculator) => {
  ...
  else if (standardGlassType) {
    // 处理映射后的其他玻璃类型
    calculator.writeGlass(customer, style, widthStr, heightStr, '', id, id + '--01', 2 * q, standardGlassType, '', fixedglassw, fixedglassh, grid, argon);
  }

  // 添加Sash Welding计算，如果需要
  calculator.writeSashWeldingEntry({ ID: id, Customer: customer, Style: style, sashw: 0, sashh: 0 });
